...
func TestDatabaseUpdate(t *testing.T) {
	...
	_, err := client.D1.Database.Update(
		context.TODO(),
		"xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
		d1.DatabaseUpdateParams{
			AccountID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
			ReadReplication: cloudflare.F(d1.DatabaseUpdateParamsReadReplication{
				Mode: cloudflare.F(d1.DatabaseUpdateParamsReadReplicationModeAuto),
			}),
		},
	)
	if err != nil {
...
func TestDatabaseEditWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.D1.Database.Edit(
		context.TODO(),
		"xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
		d1.DatabaseEditParams{
			AccountID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
			ReadReplication: cloudflare.F(d1.DatabaseEditParamsReadReplication{
				Mode: cloudflare.F(d1.DatabaseEditParamsReadReplicationModeAuto),
			}),
		},
	)
	if err != nil {
