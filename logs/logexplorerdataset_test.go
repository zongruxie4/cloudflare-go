...
func TestLogExplorerDatasetNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Logs.LogExplorer.Datasets.New(context.TODO(), logs.LogExplorerDatasetNewParams{
		CreateRequest: logs.CreateRequestParam{
			Dataset: cloudflare.F("dataset"),
			Fields: cloudflare.F([]logs.CreateRequestFieldParam{{
...
func TestLogExplorerDatasetUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Logs.LogExplorer.Datasets.Update(
		context.TODO(),
		"dataset_id",
...
func TestLogExplorerDatasetListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Logs.LogExplorer.Datasets.List(context.TODO(), logs.LogExplorerDatasetListParams{
		AccountID:    cloudflare.F("account_id"),
...
func TestLogExplorerDatasetGetWithOptionalParams(t *testing.T) {
	...
	_, err := client.Logs.LogExplorer.Datasets.Get(
		context.TODO(),
		"dataset_id",
		logs.LogExplorerDatasetGetParams{
			AccountID: cloudflare.F("account_id"),
		},
	)
	if err != nil {
